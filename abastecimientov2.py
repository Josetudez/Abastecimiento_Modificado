...
def reservas_avisorden_ordenes(connection):
    ...
    try:
        ...
        tabla_ordenes.rename(columns={"material": "modelo", "orden_prio": "prio_orden","orden_prio_texto" :"prio_orden_texto" , "gruplan" : "grupo_planif"},inplace=True)
        tabla_aviso.drop(columns=['id','fechacarga','grupo_planif'],inplace=True)
        ...
        unir_reservaxorden_aviso.drop(columns='eq_est_usu', inplace=True)
